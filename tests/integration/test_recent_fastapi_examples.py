...
async def test_background_task_endpoint_schedules_email(client, monkeypatch):
    ...
    monkeypatch.setattr("app.api.background.simulate_send_email", fake_send_email)
