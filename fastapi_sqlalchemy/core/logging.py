...
def _patch_loguru_pretty() -> None:
    ...
    def make_wrapper(orig):
        ...
        def wrapper(self, __message, *args, **kwargs):
            ...
            # opt(depth=1) so loguru skips this wrapper frame in its stack walk
            return orig(self.opt(depth=1), __message, *args, **kwargs)
    ...
    setattr(LoggerCls, "_pretty_data_patched", True)
