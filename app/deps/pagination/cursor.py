...
class CursorPagination(BaseModel):
    ...
    cursor: int | None = Field(default=None, description="游标（上一页最后一条记录的 id），首页不传")
...
class CursorPage[T](BaseModel):
    ...
    next_cursor: int | None = Field(default=None, description="下一页游标，为 None 表示无更多数据")
...
type CursorPageDep = Annotated[CursorPagination, Depends()]
